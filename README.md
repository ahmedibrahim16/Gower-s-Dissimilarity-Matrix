The following code in the attached function computes the dissimilarity matrix, based on method description by Gower(1971), complemented by description for ordinal features from Rousseeuw
(1990, pp. 30–31).  
